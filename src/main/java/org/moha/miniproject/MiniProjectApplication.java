...
public class MiniProjectApplication {
    ...
    // userService.saveUser(new User(null, "Mohamed", "moha", "1234", new
    // ArrayList<>()));
    // userService.saveUser(new User(null, "Ahmed", "ahmed", "1234", new
    // ArrayList<>()));
    // userService.saveUser(new User(null, "Ali", "ali", "1234", new
    // ArrayList<>()));
    // userService.saveUser(new User(null, "Khalid", "khalid", "1234", new
    // ArrayList<>()));
